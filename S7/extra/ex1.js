...
/*const filterVideoGames = videogames.filter(function(element){
...
const filterVideoGames = videogames.filter(videogame => videogame.genders.find(genders => genders == 'RPG'));
