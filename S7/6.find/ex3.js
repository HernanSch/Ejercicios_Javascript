...
const foundAliens = aliens.find(alien => alien.name === 'Cucushumushu');

const foundMutations = mutations.find(mut => mut.name === 'Porompompero');

const spread = {...foundMutations, ...foundAliens};
