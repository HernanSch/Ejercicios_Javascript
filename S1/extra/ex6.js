...
for (let i = 0; i < products.length; i++){
    ...
    else badProducts.push(products)
}
console.log("Se han añadido a la lista Good Products las siguientes peliculas: " + goodProducts);
console.log("Se han añadido a la lista Bad Products las siguientes peliculas: " + badProducts);      